...
from tract 9813 are:\\[2\baselineskip]
...
} & \textbf{Operator+SRD Requirement\\
} & \textbf{Value}\tabularnewline
PA2 & HSC-G & mmag & \textless{}= 15.0 & 28.8\tabularnewline
PF1 & HSC-G & \% & \textless{}= 10.0 & 30.2\tabularnewline
PA2 & HSC-I & mmag & \textless{}= 15.0 & 32.6\tabularnewline
PF1 & HSC-I & \% & \textless{}= 10.0 & 34.6\tabularnewline
PA2 & HSC-R & mmag & \textless{}= 15.0 & 33.4\tabularnewline
PF1 & HSC-R & \% & \textless{}= 10.0 & 34.4\tabularnewline
\bottomrule
\end{tabular}\\[\baselineskip]

Note that because the science pipelines are still in development, the
actual resulting values for these metrics are not important. The
requirement to be satisfied is that we have (a) provided the software to
calculate them, and (b) provided a framework for comparing them to
requirements. These are both satisfied.
...
PA2 & HSC-Y & mmag & \textless{}= 22.5 & 34.2\tabularnewline
PF1 & HSC-Y & \% & \textless{}= 10.0 & 20.5\tabularnewline
PA2 & HSC-Z & mmag & \textless{}= 22.5 & 27.4\tabularnewline
PF1 & HSC-Z & \% & \textless{}= 10.0 & 15.6\tabularnewline
\bottomrule
\end{tabular}\\[\baselineskip]
...
requirement to be satisfied is that we have (a) provided the software to
calculate them, and (b) provided a framework for comparing them to
requirements. These are both satisfied.\\[2\baselineskip]This step is
given a status of ``Initial Pass'' because there are no u-band data to
test on. We have demonstrated that the capability is provided, but
simply do not have data to pass through the code.
...
PA1 & HSC-Y & mmag & \textless{}= 7.5 & 15.5\tabularnewline
PA1 & HSC-Z & mmag & \textless{}= 7.5 & 12.9\tabularnewline
\bottomrule
\end{tabular}\\[\baselineskip]
...
PA1 & HSC-G & mmag & \textless{}= 5.0 & 13.5\tabularnewline
PA1 & HSC-I & mmag & \textless{}= 5.0 & 14.9\tabularnewline
PA1 & HSC-R & mmag & \textless{}= 5.0 & 15.5\tabularnewline
\bottomrule
\end{tabular}\\[\baselineskip]
