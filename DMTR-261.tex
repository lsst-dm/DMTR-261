...
requirements (\citeds{LSE-61}) requirements related to the LSST Science
Pipelines. It will be executed in conjunction with the release of
Science Pipelines Version 20.0.0, but the pipeline release is not
contingent upon this test campaign. This Test Plan aims to demonstrate
that the included requirements have been met by Version 20.0.0 of the
Pipelines, and to thus fully verify their completion and readiness for
LSST commissioning.
